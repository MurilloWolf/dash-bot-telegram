...
describe('seedCompleteDatabase', () => {
  ...
  it('should display correct statistics', async () => {
    ...
    expect(mockConsoleLog).toHaveBeenCalledWith('   👥 Users: 5');
    expect(mockConsoleLog).toHaveBeenCalledWith('   🏆 Usuários Premium: 5');
    expect(mockConsoleLog).toHaveBeenCalledWith('   📦 Products: 3');
    ...
    expect(mockConsoleLog).toHaveBeenCalledWith('   🏃‍♂️ Races: 8');
